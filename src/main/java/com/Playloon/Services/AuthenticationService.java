...
public class AuthenticationService {
    ...
    //sgjBsJ9ZpB6OoDhf/4gfgqsn915WQfUYw4+4aoQFCPc=
    public static void main(String[] args) {
        System.out.println(new AuthenticationService().generateSecurePassword("alex"));

        boolean test = new AuthenticationService().verifyUserPassword("alex", "sgjBsJ9ZpB6OoDhf/4gfgqsn915WQfUYw4+4aoQFCPc=");
